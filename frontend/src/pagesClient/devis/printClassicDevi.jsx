      ...
      <Box m="1.5rem 2.5rem">
        <Paper elevation={3} style={{ padding: theme.spacing(3), marginBottom: theme.spacing(3), border: `1px solid ${theme.palette.grey[300]}` }}>
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
            ...
            <Box textAlign="right">
              <Typography variant="h4" fontWeight="bold" sx={{ color: theme.palette.primary.main }}>DEVIS</Typography>
              <Typography variant="h6">DEVI N°: #{_id}</Typography>
              <Typography variant="h6" sx={{ color: getStatusColor(deviStatus), '@media print': { display: 'none' } }}>Status: {deviStatus}</Typography>
            </Box>
          </Box>
          ...
          <Box display="flex" justifyContent="space-between" mb={3}>
            ...
            <Box textAlign="right">
              <Typography variant="h6" fontWeight="bold" mb={1}>Devi à:</Typography>
...
export default PrintClassicDevi;
